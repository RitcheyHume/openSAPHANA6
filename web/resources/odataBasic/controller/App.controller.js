...
sap.ui.define([
	...
	return BaseController.extend("opensap.odataBasic.controller.App", {
		...
		onInit: function() {
			console.debug("Entered onInit function");
			...
			function fnLoadMetadata() {
				console.debug("Entered fnLoadMetadata");
				oTable.setModel(bpModel);
				oTable.setEntitySet("BusinessPartners");
			...
			console.debug("before attachMetadataLoaded function called");
			bpModel.attachMetadataLoaded(bpModel, function() {
				console.debug("attachMetadataLoaded anonymous function called");
				fnLoadMetadata();
			});
			console.debug("after attachMetadataLoaded function called");
			fnLoadMetadata();
		},
